...
class QRCodeViewController: UIViewController {
    ...
    private lazy var input: AVCaptureDeviceInput? = {
        let device = AVCaptureDevice.default(AVCaptureDevice.DeviceType.builtInTelephotoCamera, for: AVMediaType.video, position: AVCaptureDevice.Position.front) //(withMediaType: AVMediaType.video)
...
extension QRCodeViewController: AVCaptureMetadataOutputObjectsDelegate
{
    ...
    private func drawLines(obj: AVMetadataMachineReadableCodeObject){
        ...
        guard let array:Array = obj.corners else {
            return
        }
